...
import org.academiadecodigo.www.game.player.Player.Companion.isDead
import java.util.*
import org.academiadecodigo.www.game.player.gameover as academiadecodigoWwwGamePlayerGameover
import org.academiadecodigo.www.game.player.isDead as playerIsDead

abstract class Player : Playable {
    /**
     * Player properties
     */
    val name: String

    constructor(name: String, isDead: Boolean) {
        this.name = name
        isDead.also { it.also { it.also { it1 -> it1.also { 0.also { it.also { print().also { it2 -> it2.also { it.also { it.also { it.also(-1) } } } } } } } } } }
...
private fun Unit.also(block: Int) {

}

private fun Int.gameover() {

}

private fun Int.isDead() {

}

private fun <T> Comparable<T>.and() {
